...
Como primeiro projeto, estou desenvolvendo uma aplicação web interativa que transforma o progresso de estudos em uma experiência visual única, com páginas de calendário sendo "arrancadas" de forma animada.
...
## 💡 Sobre o curso.dev (FAQ)

A seção abaixo contém informações detalhadas sobre o curso, retiradas diretamente do site oficial.

<details>
<summary>Clique para expandir e ver o FAQ completo</summary>
...
Assista ao video de apresentação para conhecer mais detalhes sobre o projeto a ser desenvolvido.
...
A última atualização de aula que o curso recebeu foi há 19 horas atrás, exatamente no dia 23/03/2026.

Inclusive foram publicadas 15 novas aulas nos últimos 3 meses, totalizando 245 aulas. 🎉
...
No momento, o curso já conta com 245 aulas com conteúdo original sobre programação e carreira na área de tecnologia. A cada semana, tenho a meta de publicar duas novas aulas com qualidade profissional onde através delas você poderá interagir diretamente comigo, com a equipe de suporte e com os outros alunos para sanar dúvidas, adicionar novas informações, trocar ideias e opiniões.
...
Aqui estão as tecnologias e os assuntos relacionados que são abordados ao longo das 245 aulas no curso:
...
Ao clicar no botão para se
 você será direcionado para a etapa de pagamento em um ambiente 100% seguro, onde poderá escolher pagar via cartão de crédito ou PIX, e poderá parcelar em até 12 vezes.
...
A política de reembolso é extremamente amigável. Você tem 30 dias para pedir o reembolso que 100% do seu dinheiro será devolvido. Basta enviar um e-mail para <contato@curso.dev> através do email que você utilizou na compra solicitando o reembolso.
...
Show! Peço que envie um email para <contato@curso.dev>.
...
**SoftMissT** (25 minutos atrás)

> Vou ser bem sincero, eu tenho hiperfoco, sou preguiçoso, estou entrando em uma aréa a qual eu entendo muuuito pouco, so tive aula de programação da faculdade de game design usando unit e no ensino médio, mas sempre fui editor de video, gamer, e sempre gostei de tecnologia, então de vez enquando quando procurava algo de programação, o Felipe sempre aparecia, então quando comprei o curso, foi um um caminho novo, e ta mt bom pq estou aprendendo coisas que não sabia, e o esquema de trilhas, é muito bom.
